(function(nx) {
    ...
    var EXPORT = nx.define("glance.paging.PageSearch", glance.paging.Page, {
        view: {
        ...
        properties: {
            matched: {
                dependencies: "service.registered.data, input.value",
                value: function(registered, value) {
                    if (registered && value) {
                        return registered.filter(function(client) {
                            return glance.common.Util.matchRate(value, nx.path(client, "name")) >= 0;
                        });
                    }
                }
            }
