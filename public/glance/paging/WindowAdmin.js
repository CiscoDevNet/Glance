(function(nx) {
    var EXPORT = nx.define("glance.paging.WindowAdmin", glance.paging.Window, {
        view: {
            cssclass: "app-admin",
            extend: {
                pages: {
                    content: [{
                        name: "pageAdmin",
                        type: "glance.paging.PageAdmin",
                        events: {
                            select: "onSelect"
                        }
                    }, {
                        name: "pageSetup",
                        type: "glance.paging.PageSetup",
                        events: {
                            cancel: "onCancel"
                        }
                    }, {
                        name: "pageRegisterExpert",
                        type: "glance.paging.PageRegisterExpert",
                        events: {
                            cancel: "onCancel"
                        }
                    }, {
                        name: "pageRegisterMap",
                        type: "glance.paging.PageRegisterMap",
                        events: {
                            cancel: "onCancel"
                        }
                    }, {
                        name: "pageBackup",
                        type: "glance.paging.PageBackup",
                        events: {
                            cancel: "onCancel"
                        }
                    }]
