(function (nx, position, dom, ui, global) {
    ...
    var CLASS = nx.define("nxex.common.AutoComplete", nxex.struct.Element, {
        events: ["execute_change", "execute_selection", "focus", "blur"],
        struct: {
            properties: {
            ...
            content: [{
                name: "input",
                type: "nxex.common.CommonContenteditable",
                properties: {
                    class: "input form-control",
                    tabindex: binding("tabindex"),
                    contenteditable: binding("contenteditable")
                },
                events: {
                ...
                properties: {
                    tabindex: 0,
                    class: ["list", binding("listVisibilityClass_internal_")],
                    style: {
                        position: "absolute"
                    }
                },
                content: binding("listItemTemplate", function (listItemTemplate) {
                    if (listItemTemplate) {
                        return template({
                            source: "listData",
        ...
        properties: {
            ...
            listVisibilityClass_internal_: {
                value: nx.keyword.binding("listVisibility_internal_", function (b) {
                    return b ? "" : "hidden";
                })
            },
            listItemTemplate: {
        ...
        statics: {
            ...
            adjustListPosition: function (mode, input, list) {
                var parent = input.dom().$dom.offsetParent;
                if (!parent) {
                    return;
                }
