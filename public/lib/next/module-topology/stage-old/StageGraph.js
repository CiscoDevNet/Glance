        ...
        struct: {
            ...
            events: {
                mousewheel: function (sender, evt) {
                    var vertex = [evt.offsetX, evt.offsetY];
                    this.naturalTerminal(true);
                    if (evt.deltaY > 0) {
                        this._applyStageScale(.8, vertex);
                    } else {
                        this._applyStageScale(1.25, vertex);
                    }
                },
            ...
            content: [{
                ...
                content: [{
                    ...
                    events: {
                        click: function (sender, evt) {
                            var vertex = [this.getWidth() / 2, this.getWidth() / 2];
                            this._applyStageScale(1.25, vertex);
                        }
                    }
                }, {
                    ...
                    events: {
                        scaling: function (sender, data) {
                            var vertex = [this.getWidth() / 2, this.getWidth() / 2];
                            this._applyStageScale(data.scaling / this.stage().scale(), vertex);
                        }
                    }
                }, {
                    name: "btnZoomOut",
